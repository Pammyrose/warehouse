...
<div class="rounded-lg p-6 w-full max-w-md shadow-xl border bg-white relative">
    <button onclick="window.location.href='product.php'" class="absolute top-3 right-3 text-gray-500 hover:text-gray-700 text-2xl font-bold" aria-label="Close modal">&times;</button>

    <h2 class="text-xl font-semibold mb-6">Update Product</h2>
    ...
    <form method="POST" action="">
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="button" onclick="window.location.href='product.php'" class="bg-gray-300 text-gray-800 px-5 py-2 rounded hover:bg-gray-400 transition">Cancel</button>
        </div>
    </form>
</div>